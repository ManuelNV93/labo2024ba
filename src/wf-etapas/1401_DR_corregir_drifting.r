...
vmediana <- c(4.592592593, 4.493827160, 4.456790123, 4.148148148, 3.876543210, 3.703703704, 
             3.481481481, 3.604938272, 3.777777778, 3.723169772, 3.827160494, 3.812385201, 
             3.604938272, 3.189976384, 3.206769877, 2.637890318, 2.826292312, 2.913580247, 
             2.061728395, 1.938271605, 1.925925926, 1.900551036, 1.709876543, 1.703703704, 
             1.522348585, 1.555555556, 1.156389399, 1.117540218, 1.176594070, 1.161637366, 
             1.133108459, 1.031473155, 0.979635017, 1.000000000)

#------------------------------------------------------------------------------

drift_mediana <- function(campos_monetarios) {
  cat( "inicio drift_mediana()\n")
  
  dataset[tb_indices,
          on = c(envg$PARAM$dataset_metadata$periodo),
          (campos_monetarios) := .SD * i.mediana,
          .SDcols = campos_monetarios
  ]
  
  cat( "fin drift_mediana()\n")
}
#------------------------------------------------------------------------------
...
switch(envg$PARAM$metodo,
  ...
  "mediana"   = drift_mediana(campos_monetarios)
)
